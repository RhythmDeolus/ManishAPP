    ...
    <>
        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <a href="/" className="flex ml-2 md:mr-36">
            ...
            <div className="flex items-center">
              ...
              <div className="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown">
                ...
                <div className="grid grid-cols-3 gap-4 p-4">
                  ...
                  <a href="#" className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                    <svg className="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-40  0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5 2a2 2 0 00-2 2v14l3.5-2 3.5 2 3.5-2 3.5 2V4a2 2 0 00-2-2H5zm2.5 3a1.5 1.5 0 100 3 1.5 1.5 0 000-3zm6.207.293a1 1 0 00-1.414 0l-6 6a1 1 0 101.414 1.414l6-6a1 1 0 000-1.414zM12.5 10a1.5 1.5 0 100 3 1.5 1.5 0 000-3z" clipRule="evenodd"></path></svg>
                    <div className="text-sm font-medium text-gray-900 dark:text-white">Billing</div>
                  </a>
                  <a href="/sign_in" className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
              ...
              <div className="flex items-center ml-3">
                ...
                <div className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-2">
                  ...
                  <ul className="py-1" role="none">
                    ...
                    <li>
                      <a href="/sign_in" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Sign out</a>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      {/* <Navbar fluid className='fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700'>
        <Navbar.Brand href="/">
          ...
          <span className="self-center whitespace-nowrap text-xl font-semibold dark:text-white">CRM</span>
        </Navbar.Brand>
        <div className="flex gap-8 md:order-2">
          ...
          >
            <Dropdown.Header>
              <span className="block text-sm">Manish Dhiman</span>
              <span className="block truncate text-sm font-medium">manishdhiman@gmail.com</span>
            </Dropdown.Header>
            <Dropdown.Item><a href="/">Dashboard</a></Dropdown.Item>
            <Dropdown.Item><a href="/settings">Settings</a></Dropdown.Item>
            <Dropdown.Divider />
            <Dropdown.Item><a href="/sign_in">Sign out</a></Dropdown.Item>
          </Dropdown>
          <Navbar.Toggle />
        </div>

        <form className="max-w-md flex-1 mx-auto">
          ...
          <div className="relative">
            ...
            <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Courses, Universities..." required />
      ...
      <div className="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
        ...
        <aside id="sidebar" className="fixed font-normal top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
          <div className="h-full px-3 py-5  border-r border-gray-200  dark:border-gray-700 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul className="space-y-2 font-normal">
              {
                Object.keys(routes).map((route, index) => (

                  (route === "seperator") ? <li key={index}><hr className="my-2 border-gray-200  dark:border-gray-700" /></li> :
                    (routes[route].dropdown) ?
                      <li key ={index} data-collapse-toggle={`dropdown-example-${route}`}>
                        <button type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                          {"icon" in routes[route]? routes[route].icon : <svg className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"></svg>}
                          <span className="flex-1 ms-3 text-base text-left rtl:text-right whitespace-nowrap">{route}</span>
                        ...
                        <ul id={`dropdown-example-${route}`} className="hidden py-2 space-y-2">
                          {
                            Object.keys(routes[route]).map((subroute, index) => (
                              (subroute === "dropdown" || subroute == "icon") ? null :
                                <li key={index}>
                                  <a href={routes[route][subroute].link} className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                    <span className="ms-3">{subroute}</span>
                                  </a>
                                </li>
                            ))
                          }
                      ...
                      <li key={index}>
                        <a href={routes[route].link} className="flex text-base items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                          {(routes[route].icon)? routes[route].icon :
                          ...
                          <span className="ms-3">{route}</span>
                        </a>
                      </li>
                ))
              }
        ...
        <div className="relative w-full h-full overflow-y-auto bg-gray-100 lg:ml-64 dark:bg-gray-900">
