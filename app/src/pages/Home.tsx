    ...
    <div className="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3">
      ...
      <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        ...
        <ul className="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400" id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist">
            <li className="w-full">
                <button id="faq-tab" data-tabs-target="#faq" type="button" role="tab" aria-controls="faq" aria-selected="true" className="inline-block w-full p-4 rounded-tl-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Top Universties</button>
            </li>
            <li className="w-full">
                <button id="about-tab" data-tabs-target="#about" type="button" role="tab" aria-controls="about" aria-selected="false" className="inline-block w-full p-4 rounded-tr-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Top Applicants</button>
            </li>
        </ul>
            ...
            <div className="hidden pt-4" id="faq" role="tabpanel" aria-labelledby="faq-tab">
              <ul role="list" className="divide-y divide-gray-200 dark:divide-gray-700">
                <li className="py-3 sm:py-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center min-w-0">
                      <img className="flex-shrink-0 w-10 h-10" src="/mit.png" alt="imac image"/>
                      <div className="ml-3">
                        <p className="font-medium text-gray-900 truncate dark:text-white">
                          Massachusetts Institute of Technology (MIT)
                        </p>
                        <div className="flex items-center justify-start flex-1 text-sm text-green-500 dark:text-green-400">
                ...
                <li className="py-3 sm:py-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center min-w-0">
                      <img className="flex-shrink-0 w-10 h-10" src="/stanford.png" alt="imac image"/>
                      <div className="ml-3">
                        <p className="font-medium text-gray-900 truncate dark:text-white">
                        Stanford University
                        </p>
                ...
                <li className="py-3 sm:py-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center min-w-0">
                      <img className="flex-shrink-0 w-10 h-10" src="/oxford.png" alt="watch image"/>
                      <div className="ml-3">
                        <p className="font-medium text-gray-900 truncate dark:text-white">
                        University of Oxford
                        </p>
                        <div className="flex items-center justify-start flex-1 text-sm text-red-600 dark:text-red-500">
                          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <li className="py-3 sm:py-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center min-w-0">
                      <img className="flex-shrink-0 w-10 h-10" src="/cambrige.png" alt="ipad image"/>
                      <div className="ml-3">
                        <p className="font-medium text-gray-900 truncate dark:text-white">
                ...
                <li className="py-3 sm:py-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center min-w-0">
                      <img className="flex-shrink-0 w-10 h-10" src="/singapore.png" alt="imac image"/>
                      <div className="ml-3">
                        <p className="font-medium text-gray-900 truncate dark:text-white">
              ...
              <ul role="list" className="divide-y divide-gray-200 dark:divide-gray-700">
                <li className="py-3 sm:py-4">
                  <div className="flex items-center space-x-4">
                    <div className="flex-shrink-0">
                      <img className="w-8 h-8 rounded-full" src="/avatar.png" alt="Neil image"/>
                    </div>
    ...
    <div className="grid w-full grid-cols-1 gap-4 mt-4 xl:grid-cols-2 2xl:grid-cols-3">
      <div className="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        <div className="w-full">
          <h3 className="text-base font-normal text-gray-500 dark:text-gray-400">New Applicants</h3>
      ...
      <div className="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        <div className="w-full">
          <h3 className="text-base font-normal text-gray-500 dark:text-gray-400">Courses</h3>
          <span className="text-2xl font-bold leading-none text-gray-900 sm:text-3xl dark:text-white">2,340</span>
          <p className="flex items-center text-base font-normal text-gray-500 dark:text-gray-400">
            <span className="flex items-center mr-1.5 text-sm text-green-500 dark:text-green-400">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        <div className="w-full">
          <h3 className="mb-2 text-base font-normal text-gray-500 dark:text-gray-400">Applicants by age</h3>
        ...
        <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
          <div className="items-center justify-between pb-4 border-b border-gray-200 sm:flex dark:border-gray-700">
            ...
            <div className="w-full max-w-lg">
              <div date-rangepicker={true.toString()} className="grid items-center grid-cols-2 gap-4">
    ...
    <div className="grid grid-cols-1 my-4 xl:grid-cols-2 xl:gap-4">
      ...
      <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800 xl:mb-0">
        ...
        <ol className="relative border-l border-gray-200 dark:border-gray-700">                  
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Application Submitted to Harvard University</h3>
          <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">The application for John Doe has been successfully submitted to Harvard University for the Computer Science program.</p>
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Interview Scheduled with Stanford University</h3>
          <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">An interview has been scheduled for Jane Smith with Stanford University for the MBA program.</p>
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Application Reviewed by MIT</h3>
        <p className="text-base font-normal text-gray-500 dark:text-gray-400">The application for Michael Johnson has been reviewed by MIT for the Mechanical Engineering program.</p>
          </li>
        </ol>
      </div>
      <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        <div id="carousel" className="relative z-0" data-carousel="">
          <div className="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
                ...
                <h3 className="mb-4 text-2xl font-medium text-gray-900 dark:text-white">Your student applications are up by 44% this year</h3>
                <p className="mb-4 text-gray-500 dark:text-gray-400">Manage your student applications efficiently with our CRM. Track applications, schedule interviews, and communicate with universities seamlessly.</p>
                <p className="mb-2 text-lg font-medium text-gray-900 dark:text-white">Key Features:</p>
                <ul className="pl-4 mb-4 space-y-3 text-gray-500 list-disc dark:text-gray-400">
                  <li>Track application statuses in real-time.</li>
                  <li>Schedule and manage interviews with universities.</li>
                  <li>Automate communication with applicants and universities.</li>
                  <li>Generate detailed reports on application progress.</li>
                </ul>
                ...
                <p className="mb-4 text-gray-500 dark:text-gray-400">Optimize your CRM for managing student applications to various universities. Enhance your workflow and improve communication with applicants and institutions.</p>
                ...
                <ul role="list" className="pl-2 mb-4 space-y-3 text-gray-500 list-disc dark:text-gray-400">
                  <li className="flex space-x-2">
                    ...
                    <span className="leading-tight">Track application statuses in real-time</span>
                  </li>
                  <li className="flex space-x-2">
                    ...
                    <span className="leading-tight">Schedule and manage interviews with universities</span>
                  </li>
                  <li className="flex space-x-2">
                    ...
                    <span className="leading-tight">Automate communication with applicants and universities</span>
                  </li>
                  <li className="flex space-x-2">
                    ...
                    <span className="leading-tight">Generate detailed reports on application progress</span>
                  </li>
                  <li className="flex space-x-2">
                    ...
                    <span className="leading-tight">Build relationships with universities to streamline processes</span>
                  </li>
                  <li className="flex space-x-2">
                  ...
                  <span className="leading-tight">Ensure applicants feel supported throughout the process</span>
                  </li>
                </ul>
                <a href="#" className="inline-flex items-center p-2 font-medium rounded-lg text-primary-700 hover:bg-gray-100 dark:text-primary-500 dark:hover:bg-gray-700">
                  Let's start
                ...
                <h3 className="mb-4 text-2xl font-medium text-gray-900 dark:text-white">Enhance Your Student Application Management</h3>
                <p className="text-gray-500 dark:text-gray-400">Streamline your student application process with our CRM. Manage applications, schedule interviews, and communicate with universities efficiently.</p>
                ...
                <ul role="list" className="pl-2 my-5 mb-4 space-y-3 text-gray-500 list-disc dark:text-gray-400">
                  <li className="flex space-x-3">
                    ...
                    <span className="leading-tight">Real-time application tracking</span>
                  </li>
                  <li className="flex space-x-3">
                    
                    <svg className="flex-shrink-0 w-5 h-5 text-purple-600 dark:text-purple-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
                    <span className="leading-tight">Automated interview scheduling</span>
                  </li>
                  <li className="flex space-x-3">
                    
                    <svg className="flex-shrink-0 w-5 h-5 text-purple-600 dark:text-purple-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
                    <span className="leading-tight">Seamless communication with universities</span>
                  </li>
                  <li className="flex space-x-3">
                    
                    <svg className="flex-shrink-0 w-5 h-5 text-purple-600 dark:text-purple-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
                    <span className="leading-tight">Detailed reporting and analytics</span>
                  </li>
                </ul>
    ...
    <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
      ...
      <div className="items-center justify-between lg:flex">
        ...
        <div className="items-center sm:flex">
          <div className="flex items-center">
            ...
            <div id="dropdown" className="z-10 hidden w-56 p-3 bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <ul className="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                ...
                <li className="flex items-center">
                  <input id="fitbit" type="checkbox" value="" defaultChecked={true} className="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                ...
                <li className="flex items-center">
                  <input id="asus" type="checkbox" value="" defaultChecked={true} className="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
          ...
          <div date-rangepicker={true.toString()} className="flex items-center space-x-4">
            <div className="relative">
              <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                <svg className="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path d="M5.25 12a.75.75 0 01.75-.75h.01a.75.75 0 01.75.75v.01a.75.75 0 01-.75.75H6a.75.75 0 01-.75-.75V12zM6 13.25a.75.75 0 00-.75.75v.01c0 .414.336.75.75.75h.01a.75.75 0 00.75-.75V14a.75.75 0 00-.75-.75H6zM7.25 12a.75.75 0 01.75-.75h.01a.75.75 0 01.75.75v.01a.75.75 0 01-.75.75H8a.75.75 0 01-.75-.75V12zM8 13.25a.75.75 0 00-.75.75v.01c0 .414.336.75.75.75h.01a.75.75 0 00.75-.75V14a.75.75 0 00-.75-.75H8zM9.25 10a.75.75 0 01.75-.75h.01a.75.75 0 01.75.75v.01a.75.75 0 01-.75.75H10a.75.75 0 01-.75-.75V10zM10 11.25a.75.75 0 00-.75.75v.01c0 .414.336.75.75.75h.01a.75.75 0 00.75-.75V12a.75.75 0 00-.75-.75H10zM9.25 14a.75.75 0 01.75-.75h.01a.75.75 0 01.75.75v.01a.75.75 0 01-.75.75H10a.75.75 0 01-.75-.75V14zM12 9.25a.75.75 0 00-.75.75v.01c0 .414.336.75.75.75h.01a.75.75 0 00.75-.75V10a.75.75 0 00-.75-.75H12zM11.25 12a.75.75 0 01.75-.75h.01a.75.75 0 01.75.75v.01a.75.75 0 01-.75.75H12a.75.75 0 01-.75-.75V12zM12 13.25a.75.75 0 00-.75.75v.01c0 .414.336.75.75.75h.01a.75.75 0 00.75-.75V14a.75.75 0 00-.75-.75H12zM13.25 10a.75.75 0 01.75-.75h.01a.75.75 0 01.75.75v.01a.75.75 0 01-.75.75H14a.75.75 0 01-.75-.75V10zM14 11.25a.75.75 0 00-.75.75v.01c0 .414.336.75.75.75h.01a.75.75 0 00.75-.75V12a.75.75 0 00-.75-.75H14z"></path>
