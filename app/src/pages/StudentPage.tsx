      ...
      <div className="mx-auto max-w-screen-lg px-4 2xl:px-0">
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
              <div className="flex items-center">
                ...
                <a href="#" className="ms-1 text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white md:ms-2">Students</a>
              </div>
            </li>
            <li aria-current="page">
              <div className="flex items-center">
                ...
                <span className="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">Student</span>
              </div>
            </li>
          </ol>
        </nav>
        <h2 className="mb-4 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl md:mb-6">Detail</h2>
        <div className="grid grid-cols-2 gap-6 border-b border-t border-gray-200 py-4 dark:border-gray-700 md:py-8 lg:grid-cols-4 xl:gap-16">
          <div>
            ...
            <h3 className="mb-2 text-gray-500 dark:text-gray-400">Applications Submitted</h3>
          ...
          <div>
            ...
            <h3 className="mb-2 text-gray-500 dark:text-gray-400">Reviews Received</h3>
            <span className="flex items-center text-2xl font-bold text-gray-900 dark:text-white"
            >16
              <span className="ms-2 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">
          <svg className="-ms-1 me-1 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <h3 className="mb-2 text-gray-500 dark:text-gray-400">Favorite Universities</h3>
            <span className="flex items-center text-2xl font-bold text-gray-900 dark:text-white"
            >8
          ...
          <div>
            ...
            <h3 className="mb-2 text-gray-500 dark:text-gray-400">Applications Withdrawn</h3>
            <span className="flex items-center text-2xl font-bold text-gray-900 dark:text-white"
            >2
              <span className="ms-2 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">
          <svg className="-ms-1 me-1 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div className="py-4 md:py-8">
          ...
          <img className="h-16 w-16 rounded-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/helene-engels.png" alt="Student avatar" />
          <div>
            <span className="mb-2 inline-block rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"> Active Student </span>
            <h2 className="flex items-center text-xl font-bold leading-none text-gray-900 dark:text-white sm:text-2xl">John Doe</h2>
          </div>
              </div>
              <dl className="">
          <dt className="font-semibold text-gray-900 dark:text-white">Email Address</dt>
          <dd className="text-gray-500 dark:text-gray-400">john.doe@example.com</dd>
              </dl>
              <dl>
          ...
          <dd className="flex items-center gap-1 text-gray-500 dark:text-gray-400">
            ...
            123 Main St, Springfield, USA
              ...
              <dl>
          <dt className="font-semibold text-gray-900 dark:text-white">Preferred University</dt>
          <dd className="flex items-center gap-1 text-gray-500 dark:text-gray-400">
            <svg className="hidden h-5 w-5 shrink-0 text-gray-400 dark:text-gray-500 lg:inline" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          ...
          <dd className="text-gray-500 dark:text-gray-400">+1 234 567 890</dd>
              ...
              <dl>
          <dt className="font-semibold text-gray-900 dark:text-white">Application Status</dt>
          <dd className="flex items-center gap-1 text-gray-500 dark:text-gray-400">
            <svg className="hidden h-5 w-5 shrink-0 text-gray-400 dark:text-gray-500 lg:inline" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
              <path
                stroke="currentColor"
            ...
            Application in Review
              ...
              <dl>
          <dt className="font-semibold text-gray-900 dark:text-white">Assigned Counselor</dt>
          <dd className="text-gray-500 dark:text-gray-400">Jane Smith</dd>
              </dl>
              <dl>
          ...
          <dd className="flex items-center space-x-4 text-gray-500 dark:text-gray-400">
            ...
            <div>
              <div className="text-sm">
                <p className="mb-0.5 font-medium text-gray-900 dark:text-white">Visa ending in 1234</p>
                <p className="font-normal text-gray-500 dark:text-gray-400">Expiry 12/2025</p>
              </div>
            </div>
          </dd>
              </dl>
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800 md:p-8">
          <h3 className="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Recent Applications</h3>
          <div className="flex flex-wrap items-center gap-y-4 border-b border-gray-200 pb-4 dark:border-gray-700 md:pb-5">
            <dl className="w-1/2 sm:w-48">
              <dt className="text-base font-medium text-gray-500 dark:text-gray-400">Application ID:</dt>
              <dd className="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">
          <a href="#" className="hover:underline">#APP12546798</a>
              </dd>
            </dl>
            ...
            <dl className="w-1/2 sm:w-1/5 md:flex-1 lg:w-auto">
              <dt className="text-base font-medium text-gray-500 dark:text-gray-400">University:</dt>
              <dd className="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">Harvard University</dd>
            </dl>
          ...
          <ul className="p-2 text-left text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="actionsMenuDropdown10">
            ...
            <dl className="w-1/2 sm:w-48">
              <dt className="text-base font-medium text-gray-500 dark:text-gray-400">Application ID:</dt>
              <dd className="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">
              <a href="#" className="hover:underline">#APP12546777</a>
              </dd>
            </dl>
            ...
            <dl className="w-1/2 sm:w-1/5 md:flex-1 lg:w-auto">
              <dt className="text-base font-medium text-gray-500 dark:text-gray-400">University:</dt>
              <dd className="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">Stanford University</dd>
            </dl>
            ...
            <dl className="w-1/2 sm:w-48">
              <dt className="text-base font-medium text-gray-500 dark:text-gray-400">Application ID:</dt>
              <dd className="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">
              <a href="#" className="hover:underline">#APP12546846</a>
              </dd>
            </dl>
            ...
            <dl className="w-1/2 sm:w-1/5 md:flex-1 lg:w-auto">
              <dt className="text-base font-medium text-gray-500 dark:text-gray-400">University:</dt>
              <dd className="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">MIT</dd>
            </dl>
            ...
            <dl className="w-1/2 sm:w-48">
              <dt className="text-base font-medium text-gray-500 dark:text-gray-400">Application ID:</dt>
              <dd className="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">
              <a href="#" className="hover:underline">#APP12546212</a>
              </dd>
            </dl>
                        ...
                        <li>
                          <button type="button" className="inline-flex w-full rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
                            <span className="inline-flex items-center">
                              <svg fill="none" aria-hidden="true" className="me-2 h-4 w-4" viewBox="0 0 20 15">
                                <rect width="19.6" height="14" y=".5" fill="#fff" rx="2" />
                                <mask id="a" mask-type="luminance" width="20" height="15" x="0" y="0" maskUnits="userSpaceOnUse">
                                  <rect width="19.6" height="14" y=".5" fill="#fff" rx="2" />
                                </mask>
                                <g mask="url(#a)">
                                  <path fill="#D02F44" fill-rule="evenodd" d="M19.6.5H0v.933h19.6V.5zm0 1.867H0V3.3h19.6v-.933zM0 4.233h19.6v.934H0v-.934zM19.6 6.1H0v.933h19.6V6.1zM0 7.967h19.6V8.9H0v-.933zm19.6 1.866H0v.934h19.6v-.934zM0 11.7h19.6v.933H0V11.7zm19.6 1.867H0v.933h19.6v-.933z" clip-rule="evenodd" />
