              ...
              <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                {applications.map((application) => (
                  <tr key={application.id} className="hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{application.status}</td>
                    <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{new Date(application.created_on).toLocaleDateString()}</td>
